          ...
          <div className="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
            <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
              <div className="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                <Image
                  className="absolute inset-0 h-full w-full rounded-2xl object-cover object-left shadow-2xl"
                  src="/father.jpg"
                  alt="Father Grigori"
                  width={500}
                  height={500}
            ...
            <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
              <figure className="relative isolate pt-6 sm:pt-12">
                ...
                <figcaption className="mt-8 text-base">
                  <div className="font-semibold text-white">Father Grigori</div>
                  <div className="mt-1 text-gray-400">Mayor of Ravenholm</div>
                </figcaption>
              </figure>
            </div>
          </div>
